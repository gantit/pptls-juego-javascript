...
var msj = {
    ...
    msjThk: {
        ...
        t4: '<p> Es un Nombre personal (', t5: ') ¿Cómo se escriben los nombres? Con la primera letra en MAYÚSCULAS </p> <img src="http://haciendomemes.com/wp-content/uploads/2012/10/internet-meme1350435978.jpg" alt="Smiley face" width="250">',
            ...
            function result() {
                ...
                if ( usuarioEscoge === "piedra" || usuarioEscoge === "papel" || usuarioEscoge === "tijeras" || usuarioEscoge === "lagarto" || usuarioEscoge === "Spock" ) {
                    ...
                    if (usuarioEscoge === "tijera"){
                        ...
                        borrar();
                        thinkPcHTML +=msj.msjThk.t4 + usuarioEscoge + msj.msjThk.t5;
                        return (msjPC.innerHTML = thinkPcHTML);
                    }
